...
class DuelingDQNAgent:
    ...
    def replay(self):
        ...
        # Only train every TRAIN_FREQUENCY steps and when we have enough samples
...
class UniswapV3Trainer:
    ...
    def train(self, num_episodes: int, save_interval: int = 100, validate_interval: int = 50):
        ...
        for episode in range(num_episodes):
            # Only print every 10 episodes to reduce overhead
            if episode % 10 == 0:
            ...
            while True:
                ...
                # Train (now controlled by frequency)
                self.agent.replay()
...
def main():
    ...
    # Train
    trainer.train(num_episodes=200, save_interval=50, validate_interval=25)
